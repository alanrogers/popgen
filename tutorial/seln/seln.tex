...
shows the time path of allele $A_2$ over the range $0.01 \leq p \leq
...
\begin{figure}
  ...
  \caption{Time path of $p$, the frequency of an advantageous allele,
    $A_2$, over the range $0.01 \leq p \leq 0.99$. The model assumes
    that the fitness of the favored homozygote ($A_2A_2$) exceeds that
    of the unfavored one ($A_1A_1$) by $s=0.01$ and that there is no
