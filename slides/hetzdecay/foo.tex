...
\begin{frame}
\frametitle{Heterozygosity is variance}
\begin{columns}
\column{0.5\textwidth}
\textcolor{blue}{Assumptions}
\begin{itemize}
\item Random mating
\item Allele $A$ has frequency $p$
\item $N$ diploid individuals
\end{itemize}

\pause

Let $X$ (0,1, or 2) be the number of copies of $A$ within a random
individual.
...
\begin{itemize}
\item
$X$ is binomial with $N=2$ and $p$ equal to the frequency of $A$
within the population.
\pause
\item
Variance of a binomial is $N p (1-p)$
\pause
\item
Variance of $X$ is $2p(1-p)$.
\pause
\item
Same as heterozygosity
\end{itemize}
\end{columns}
\end{frame}
...
\begin{columns}
\column{0.6\textwidth}
\includegraphics[width=\textwidth]{buridist1.eps}
\column{0.5\textwidth}
...
\begin{columns}
\column{0.6\textwidth}
\includegraphics[width=\textwidth]{buridist2.eps}
\column{0.5\textwidth}
...
\frametitle{As heterozygosity declined w/i bottles, the variance among
  them increased}
\includegraphics[width=\textwidth]{burivar1.ps}
\end{frame}

\begin{frame}
\frametitle{As heterozygosity declined w/i bottles, the variance among
  them increased}
\includegraphics[width=\textwidth]{burivar2.ps}
\end{frame}
...
\pause
\item Next draw another gamete.  It is equally likely to have been produced by
  any of the $2N$ parental genes.  There is 1 chance in $2N$ that the second
  gene is a copy of the same parental gene as the first.
\end{enumerate}
\end{frame}
