...
\axis left label {\lines{Quantiles\cr of $\log_{10}\hat\theta_1$}}
   shiftedto x=-2.25
   ticks numbered from -2 to 3 by 1 /
\axis bottom shiftedto y=-2.25 label {$\log_{10} \theta_1$}
   ticks numbered from -2 to 3 by 1 /
...
\end{center}
\caption{Quantiles of $\hat\theta_1$\label{fig.theta0}.
1,000 data sets were simulated at each of several values of
$\theta_1$, and each was used to estimate the model's three
parameters.  In each run, $\theta_0=1000$, $\tau=7$, and $N=147$. The
